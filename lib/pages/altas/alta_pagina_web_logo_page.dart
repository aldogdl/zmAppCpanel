...
import 'package:zmcpanel/widgets/menu_main.dart';
import 'package:zmcpanel/widgets/app_barr_my.dart';
import 'package:zmcpanel/widgets/alerts_varios.dart';
import 'package:zmcpanel/singletons/alta_user_sngt.dart';
import 'package:zmcpanel/repository/user_repository.dart';
import 'package:zmcpanel/widgets/tomar_imagenes_widget.dart';
import 'package:zmcpanel/singletons/tomar_imagenes_sngt.dart';
import 'package:zmcpanel/repository/procc_roto_repository.dart';
import 'package:zmcpanel/widgets/regresar_pagina_widget.dart' as regresarPagina;
...
class _AltaPaginaWebLogoPageState extends State<AltaPaginaWebLogoPage> {
  ...
  Future<void> _initHidratar() async {
    ...
    if(altaUserSngt.createDataSitioWeb['qrWhats'].toString().isNotEmpty){
      this._qrWhats.text = altaUserSngt.createDataSitioWeb['qrWhats'];
    }
    setState(() {});
  }
